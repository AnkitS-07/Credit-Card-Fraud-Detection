...
def download_dataset():
    dataset_url = "https://drive.google.com/uc?id=1XHSf5RHH7NDHLRwFqE_WP4jCRB0GZfcM"
...
def load_model_files():
    required_files = ['fraud_detection_model.pkl', 'scaler.pkl', 'scaler_columns.pkl']
